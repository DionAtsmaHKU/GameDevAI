// The Sequence node runs all its children in sequence one after another,
// only continues if a child return success, if one child fails, it returns failed itself
